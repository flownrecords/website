                  ...
                  `}
                                ...
                                >
                                    ...
                                    <span className="flex justify-end px-2 items-center md:px-0">
                                        <div
                                            className={`relative group ${manageMode ? "hidden lg:inline-block" : "inline-block"}`}
                                        >
                                            <img
                                            ...
                                            >
                                                <ProfileCard
                                                    data={{
                                                        ...
                                                        publicProfile:
                                                            entry.user?.publicProfile ?? false,
                        ...
                        <>
                            {logbook && logbook.length === 0 ? (
                                <>
                                    <p className="text-center text-white/25 h-64 flex justify-center items-center">
                                        No entries found.
                                    </p>
                                </>
                            ) : (
