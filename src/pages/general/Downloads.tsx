            ...
            <div className="container mx-auto max-w-6xl p-4 xl:px-0">
                    ...
                    <div className="space-y-4">
                        {
                            platforms.map((platform) => (
                                <div className="flex justify-between items-center bg-secondary rounded-lg p-4 ring-2 ring-white/25" key={platform.id}>
                                    <h1 className="text-white text-lg font-medium">{platform.name}</h1>
                                    <Button text="Download" styleType="small" onClick={() => navigate(platform.link)}/>
                                </div>
                            ))
                        }
                    </div>
                ...
                <div className="ring-2 ring-white/25 rounded-lg p-4 mt-4">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4">
                        {
                            files.map((file) => (
                                <div className="bg-secondary rounded-lg p-4 ring-2 ring-white/25" id={file.id} key={file.id}>
