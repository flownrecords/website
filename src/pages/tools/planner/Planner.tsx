            ...
            <div className="container mx-auto max-w-6xl p-4">
                ...
                {showExtra && (
                    <div className="mt-4 ring-2 ring-white/25 rounded-lg p-4">
                        <h2 className="mb-2 font-semibold text-white/75">Extra Information</h2>
                        <div>
                            <div className="grid grid-cols-4 gap-4">
                ...
                {!showExtra && (
                    <div className="mt-4 ring-2 ring-white/25 rounded-lg p-4">
                        <h2 className="mb-2 font-semibold text-white/75">Existing Flight Plans</h2>
                    </div>
                )}
            </div>
