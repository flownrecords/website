            ...
            <div className="container mx-auto max-w-6xl p-4">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mt-4">
                    ...
                    {allQuestions.length > 0 ? (
                        <div
                            className="col-span-4 lg:col-span-3 p-4 ring-2 ring-white/25 rounded-lg"
                            id="all-questions"
                        >
                            <div className="grid grid-cols-9">
                                ...
                                >
                                    Sort by popularity
                                    {sortByPop === 0 && (
                                        <Minus className="h-5 w-5 inline cursor-pointer" />
                                    )}
                                    {sortByPop === 1 && (
                                        <ChevronDown className="h-5 w-5 inline cursor-pointer" />
                                    )}
                                    {sortByPop === 2 && (
                                        <ChevronUp className="h-5 w-5 inline cursor-pointer" />
                                    )}
                                </div>
                            </div>
                            {allQuestions.map((q, i) => {
                                return <QuestionBlock question={q} index={i} tags={tags} />;
                            })}
                        </div>
                    ) : (
                        <div
                                        ...
                                        <span
                                            ...
                                            onClick={() => {
                                                if (pubQuestionTags.includes(tag.id)) {
                                                    editPubQuestionTags(
                                                        pubQuestionTags.filter((t) => t !== tag.id),
                                                    );
                                                } else {
                                                    editPubQuestionTags([
                                                        ...pubQuestionTags,
