...
export default function Stats() {
    ...
    const mostFlownAircraft = 
    logbook.reduce((acc, entry) => {
    ...
    Object.values(mostFlownAircraft).sort((a, b) => b.flights - a.flights).slice(0, isMobile ? 5 : 15);
    ...
    const dayNightData = [
        {
            name: "Day",
            value: logbook.reduce((sum, e) => sum + (Number(e.dayTime) || 0) + (Number(e.simTime) || 0), 0),
        },
        {
            name: "Night",
    ...
    const landingsData = 
    Object.values(landingsDataRaw).sort((a, b) => {
